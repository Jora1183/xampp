...
<div id="solidres">
	<div class="<?php echo SR_UI_GRID_CONTAINER ?>">
		...
		<div id="sr_panel_right" class="sr_list_view <?php echo SR_UI_GRID_COL_10 ?>">
			<form action="<?php echo Route::_('index.php?option=com_solidres&view=taxes'); ?>" method="post"
				...
				<table class="table table-striped">
					...
					<tr>
						...
						<th class="w-5 hidden-phone d-none d-md-table-cell">
						...
						<th>
							<?php echo HTMLHelper::_('searchtools.sort', 'SR_HEADING_RATE', 'r.rate', $listDirn, $listOrder); ?>
						</th>
						<th class="center">
						...
						<tr class="row<?php echo $i % 2; ?>">
							...
							<td>
								<?php if ($canCreate || $canEdit) : ?>
									<a href="<?php echo Route::_('index.php?option=com_solidres&task=tax.edit&id=' . (int) $item->id); ?>">
							...
							<td class="center">
								<?php echo HTMLHelper::_('jgrid.published', $item->state, $i, 'taxes.', $canChange); ?>
							</td>
						</tr>
					<?php endforeach; ?>
					</tbody>

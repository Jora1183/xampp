    ...
    <div class="<?php echo SR_UI_GRID_CONTAINER ?>">
        ...
        <div id="sr_panel_right" class="sr_list_view <?php echo SR_UI_GRID_COL_10 ?>">
            <div class="alert alert-info">
                This feature is an integrated Reports &amp; Statistics for Solidres. It also enables the Calendar view for your property's availability
            </div>
            <div class="alert alert-success">
                <strong>Notice:</strong> plugin <strong>Statistics</strong> is not installed or enabled.
                <a target="_blank"

    ...
    <div class="<?php echo SR_UI_GRID_CONTAINER ?>">
        ...
        <div id="sr_panel_right" class="sr_list_view <?php echo SR_UI_GRID_COL_10 ?>">
            <div class="alert alert-info">
                Housekeeping plugin enables the housekeeping functionality for Solidres
            </div>
            <div class="alert alert-success">
                <strong>Notice:</strong> plugin <strong>Housekeeping</strong> is not installed or enabled.
                <a target="_blank"

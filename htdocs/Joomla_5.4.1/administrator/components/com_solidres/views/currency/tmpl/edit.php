...
<div id="solidres">
	<form enctype="multipart/form-data"
	      action="<?php echo Route::_('index.php?option=com_solidres&view=currency&layout=edit&id=' . $this->form->getValue('id')) ?>"
	      method="post"
	      name="adminForm" id="item-form" class="form-validate form-horizontal">
		<?php echo HTMLHelper::_(SR_UITAB . '.startTabSet', 'sr-currency', ['active' => 'general']) ?>

		<?php echo HTMLHelper::_(SR_UITAB . '.addTab', 'sr-currency', 'general', Text::_('SR_NEW_GENERAL_INFO', true)) ?>

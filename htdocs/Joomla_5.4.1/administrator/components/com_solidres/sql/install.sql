...
CREATE  TABLE IF NOT EXISTS `#__sr_reservations` (
  ...
  `checked_out` INT(11) UNSIGNED NOT NULL DEFAULT 0 ,
  `checked_out_time` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00' ,
  `payment_method_id` VARCHAR(20) NOT NULL DEFAULT 0 ,
  `payment_method_txn_id` VARCHAR(64) NULL DEFAULT NULL ,
  ...
  `customer_phonenumber` VARCHAR(30) NULL ,
  `customer_mobilephone` VARCHAR(30) NULL ,
  ...
  `customer_vat_number` VARCHAR(20) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `#__sr_tariffs` (
  ...
  `q_min` SMALLINT NULL,
  `q_max` SMALLINT NULL,
  `occupancy_restriction_type` TINYINT UNSIGNED NULL DEFAULT 0,
  `pricing_type` TINYINT UNSIGNED NULL DEFAULT 0,
  `cm_custom` VARCHAR(45) NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `#__sr_tariff_details` (
  ...
  `price_unoccupied` DECIMAL(20,6) UNSIGNED NULL,
  ...
  `week_from` DATE NULL DEFAULT NULL,
  `week_to` DATE NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
(62, 'East Timor', 'TL', 'TLS', 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00'),
...
(238, 'The Democratic Republic of Congo', 'CD', 'COD', 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00'),
...
(242, 'Jersey', 'JE', 'JEY', 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00'),
(243, 'St. Barthelemy', 'BL', 'BLM', 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00'),
(244, 'St. Eustatius', 'BQ', 'BES', 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00'),
(245, 'Canary Islands', 'IC', 'XCA', 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00'),

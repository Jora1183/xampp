...
INSERT INTO `#__sr_reservation_assets` (`id`, `asset_id`, `category_id`, `name`, `alias`, `address_1`, `address_2`, `city`, `postcode`, `phone`, `description`, `email`, `website`, `featured`, `fax`, `rating`, `geo_state_id`, `country_id`, `created_date`, `modified_date`, `created_by`, `modified_by`, `state`, `checked_out`, `checked_out_time`, `ordering`, `archived`, `approved`, `access`, `params`, `language`, `hits`, `metakey`, `metadesc`, `metadata`, `partner_id`, `lat`, `lng`, `default`, `deposit_required`, `deposit_is_percentage`, `deposit_amount`, `currency_id`, `tax_id`) VALUES

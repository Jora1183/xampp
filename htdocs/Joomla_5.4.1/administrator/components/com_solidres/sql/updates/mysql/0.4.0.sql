-- ALTER TABLE  `#__sr_media_reservation_assets_xref` ADD COLUMN `weight` INT(11) UNSIGNED NOT NULL DEFAULT 0;
-- ALTER TABLE  `#__sr_media_roomtype_xref` ADD COLUMN `weight` INT(11) UNSIGNED NOT NULL DEFAULT 0;
...
ALTER TABLE  `#__sr_prices` IF EXISTS CHANGE `customer_group_id`  `customer_group_id` INT( 11 ) UNSIGNED NULL DEFAULT NULL;

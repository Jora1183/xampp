...
<table class="table">
	...
	<?php if ($tourist_tax_amount > 0) : // We allow negative value for single supplement ?>
	<tr>
		<td><?php echo Text::_('SR_TOURIST_TAX_AMOUNT') ?></td>
		<td class="sr-align-right"><?php echo $touristTax->format() ?></td>
	</tr>
	<?php endif;

	if ($tariff['total_discount'] > 0 && $tariff['is_discount_pre_tax']) : ?>
        <tr>
	...
	<?php if (!$showTaxIncl) : ?>
	<tr>
		<td><?php echo Text::_('SR_TAX_AMOUNT') ?></td>
		<td class="sr-align-right"><?php echo $tariff['total_tax_formatted']->format() ?></td>
	<tr>
	<?php endif; ?>

	<?php if ($tariff['total_discount'] > 0 && !$tariff['is_discount_pre_tax']) : ?>
	<tr>
		<td><?php echo Text::_('SR_ROOM_X_DISCOUNTED_AMOUNT') ?></td>
		<td class="sr-align-right"><?php echo $tariff['total_discount_formatted']->format() ?></td>
	<tr>
    ...
    <tr>
        <td><?php echo Text::_('SR_GRAND_TOTAL') ?></td>

...
<div id="solidres">
	<form enctype="multipart/form-data" action="" method="post" name="adminForm" id="item-form"
	      class="form-validate form-horizontal">

		<?php echo HTMLHelper::_(SR_UITAB . '.startTabSet', 'sr-customergroup', ['active' => 'general', 'recall' => true]) ?>

		<?php echo HTMLHelper::_(SR_UITAB . '.addTab', 'sr-customergroup', 'general', Text::_('SR_NEW_GENERAL_INFO', true)) ?>

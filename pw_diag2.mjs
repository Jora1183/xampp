import { chromium } from '/c/Users/vyugo/AppData/Roaming/npm/node_modules/@playwright/mcp/node_modules/playwright/index.mjs';
import { execSync } from 'child_process';

// Resolve the actual executable path Windows-style
const exePath = String.raw`C:\Users\vyugo\AppData\Local\ms-playwright\chromium-1208\chrome-win64\chrome.exe`;
...
(async () => {
  ...
  console.log('=== 1. GALLEREJA / KARTA BAZY ELEMENTS ===');

...
?>">
    ...
    <div class="site-grid">
        ...
        <!-- Simple Title Section (Since Hero is removed) -->
        <div class="bg-gray-50 py-12 border-b border-gray-200">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <h1 class="text-4xl font-serif font-bold text-resort-dark">Галерея</h1>
                <div class="h-[3px] w-14 bg-resort-green mx-auto rounded-full mt-4"></div>
            </div>
        </div>
        ...
        <!-- Gallery Section - Prominently Displayed -->
        <!-- Note: This is an extra module position if user puts module here.
             They can also just put the module inside the 'component' area via an article.
             But keeping this here allows assignment to 'gallery' position. -->
